...
<script>
// import mixins_table from '@/mixins/table'
import { listCfg } from './assets/table-cfg'
export default {
    methods: {
        onQuery() {},
        onTrigger(...params) {
        ...
        return {
            ...
            table: {
                ...
                data: [
                    {
                        accessable: true,
                        accessable_status: '\u53ef\u8fbe',
                        agent_ver: 'v2.2.0',
                        arrival_time: '',
                        business_id: null,
                        business_name: null,
                        create_time: '2017-12-21 09:50:02',
                        host_sn: '2102310LXP10E3101611',
                        hostname: 'localhost.localdomain',
                        hypervisor: true,
                        id: 10,
                        ip:
                            '10.0.0.204;10.0.0.244;10.0.0.245;10.0.0.246;192.168.122.1;172.17.0.1;172.18.0.1',
                        lose_time: null,
                        manufacturer: 'Huawei Technologies Co., Ltd.',
                        model: 'Tecal RH2285H V2-12L',
                        modify_time: '2018-01-03 17:00:03',
                        os_type: 'Linux',
                        power_thres: -1,
                        rack_pos: null,
                        status: true
